...
GET    /api/v1/profile/           -> creative profile (+packages) (creative)
PUT    /api/v1/profile/           -> updated profile      (creative; headline/bio/styles/price)
POST   /api/v1/packages/          -> package              (creative; name/base_price/desc/inclusions[])
PUT    /api/v1/packages/{id}/     -> package              (creative)
DELETE /api/v1/packages/{id}/     -> 204                  (creative)
...
GET    /api/v1/bookings/{id}/collaborators/ -> [collaborator]  (owner; A-side list)
POST   /api/v1/bookings/{id}/collaborators/ -> [collaborator]  (owner; invite {creative slug, role, fee})
POST   /api/v1/bookings/{id}/collaborators/{cid}/pay/    -> collaborator (owner; pay fee)
POST   /api/v1/bookings/{id}/collaborators/{cid}/remove/ -> {removed}     (owner)
