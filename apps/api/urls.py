...
urlpatterns = [
    ...
    path("bookings/<uuid:pk>/collaborators/", views.booking_collaborators, name="booking_collaborators"),
    path("bookings/<uuid:pk>/collaborators/<int:cid>/pay/", views.booking_collaborator_pay, name="booking_collaborator_pay"),
    path("bookings/<uuid:pk>/collaborators/<int:cid>/remove/", views.booking_collaborator_remove, name="booking_collaborator_remove"),
    ...
    path("collaborations/<int:pk>/respond/", views.collaboration_respond, name="collaboration_respond"),
