...
from apps.enquiries.services import expire_quotes, quote_expiry_reminders
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            f"{delivery_reminders} delivery + {quote_nudges} quote + {pay_reminders} payment reminder(s)."
        ))
